...
;;;;
;;;; One package holds every utility: the files under src/ are independent
;;;; shelves of functions rather than layers of one design.  Demonstration
;;;; functions named SHOW-xxx are deliberately not exported.
...
(defpackage :cl-utils
  ...
  (:export
   ...
   ;; web:
   #:web-redirect-p)
  (:documentation "Personal, mostly self-contained utilities for Common Lisp."))
