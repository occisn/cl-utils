...
(parachute:define-test test-string-split
  (parachute:is
   equal (list "aa" "b b" "c c c") (string-split "aa,b b,c c c" #\,))
  (parachute:is
   equal (list "aa" "bb" "cc") (string-split "aa bb cc" #\SPACE)))
...
(parachute:define-test test-string-repeat-string
  (parachute:is string= "abc-abc-abc-" (string-repeat-string 3 "abc-"))
  (parachute:is string= "" (string-repeat-string 0 "abc-"))
  (parachute:is string= "" (string-repeat-string 10 "")))

;;; === string-add-space-at-left

(parachute:define-test test-string-add-space-at-left
  (parachute:is string= "   abc" (string-add-space-at-left "abc" :total-length 6)))
